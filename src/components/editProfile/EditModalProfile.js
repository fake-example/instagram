        ...
        <div className=''>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                ...
                <div className="relative w-auto my-6 mx-auto max-w-4xl">
                    ...
                    <div className="border-0 rounded-lg relative p-10 flex flex-col w-full bg-white outline-none focus:outline-none">

                        <div className="flex justify-center">
                            <h2 className="text-xl font-semibold text-gray-400">UPDATE PROFILE PICTURE</h2>
                        </div>

                        <div className="flex flex-col p-8 ">

                            <div className="flex justify-center px-4 py-2 text-blue-500 font-bold border">
                                <button onClick={openInput}>Upload Photo</button>
                            </div>
                            ...
                            <div className="flex justify-center px-4 py-2 mt-2 border">
                                <button className='font-bold' onClick={() => setModalOpen(false)}>Cencel</button>
                            </div>
